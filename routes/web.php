...
Route::middleware('check.auth')->group(function (){
    ...
    */
    ...
    Route::prefix('audit/tables')->group(function(){
        ...
        Route::post('/import', [TableController::class, 'import'])->name('audit.tables.import');
    ...
    Route::prefix('audit/values')->group(function(){
        ...
        Route::get('/view-2/{emp}', [ValueController::class, 'view_2'])->name('audit.values.view.2');
        Route::get('/view/{entityName}/{id}', [ValueController::class, 'view_entity'])->name('audit.values.view.entity');
        Route::get('/view/{entityName}/{id}/details/{table_id}', [ValueController::class, 'view_entity_details'])->name('audit.values.view.entity.details');
        Route::post('/store', [ValueController::class, 'store'])->name('audit.values.store');
        Route::post('/import', [ValueController::class, 'import'])->name('audit.values.import');
        ...
        Route::get('/download/model/{tbl?}/{srv?}/{ent?}/{sectr?}/{sect?}', [ValueController::class, 'download_model'])->name('audit.values.download.model');
    });
