<div class="modal fade" id="importAllTrainingsModal" tabindex="-1" aria-labelledby="importAllTrainingsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form action="{{ route('trainings.upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
