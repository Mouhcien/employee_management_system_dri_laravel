...
@props(['employee', 'levels', 'grades'])

<div class="modal fade" id="affectGradeModal" tabindex="-1" aria-labelledby="affectGradeModalLabel" aria-hidden="true">
                ...
                <div class="modal-header border-0 pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Affecter Grade</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg mb-2">
                            ...
                            <select class="form-control" name="grade_id">
                                <option> Sélectionnez le grade</option>
