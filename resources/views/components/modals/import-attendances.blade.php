@props(['training_id'])
<div class="modal fade" id="importAllAttendancesModal" tabindex="-1" aria-labelledby="importAllAttendancesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form action="{{ route('attendences.upload',$training_id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-footer border-top-0 px-4 pb-4 pt-0">
                    ...
                    <button type="submit" class="btn btn-primary px-4 py-2 fw-semibold shadow-sm">
                        <i class="bi bi-eye me-2"></i>Sauvgrader
                    </button>
                </div>
            </form>
        </div>
