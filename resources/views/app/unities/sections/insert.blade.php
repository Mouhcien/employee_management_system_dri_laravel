            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header border-0 rounded-top-4
                        ...
                        <h4 class="mb-0">
                            {{ isset($section) ? "Modifier la section ".$section->title : 'Nouvelle section' }}
                        </h4>
                        ...
                        >
                            ...
                            <div class="mb-4">
                                ...
                                >
                                    ...
                                    @foreach($services as $service)
                                        ...
                                        <option
                                            value="{{ $service->id }}"
                                            {{ isset($section) && $service->id == $section->entity->service_id ? 'selected' : (old('service_id') == $service->id ? 'selected' : '') }}
                                        >
                                            {{ $service->title }}
                                        </option>
                                        @else
                            ...
                            <div class="mb-4">
                                ...
                                >
                                    ...
                                    @foreach($entities as $entity)
                                        <option
                                            value="{{ $entity->id }}"
                                            {{ isset($section) && $entity->id == $section->entity_id ? 'selected' : (old('entity_id') == $entity->id ? 'selected' : '') }}
                                        >
                                            {{ $entity->title }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="d-flex justify-content-end gap-3 border-top pt-4">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg rounded-3">
                                    ...
                                    {{ isset($section) ? 'Mettre à jour' : 'Enregistrer' }}
                                </button>
                            </div>
                        </form>
                    </div>
