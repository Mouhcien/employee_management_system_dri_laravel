        ...
        <div class="bg-gradient-primary-to-secondary rounded-4 p-4 mb-4 text-white shadow-lg">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3">
                <div class="row col-12">
                    <div class="col-4">
                        <h1 class="h3 mb-1 fw-bold"><i class="bi bi-file-earmark-excel-fill me-2"></i>Importer les agents par fonction</h1>
                    ...
                    <div class="col-4">
                        <select name="occupation_id" class="form-control">
                            <option value="-1">Séléctionnez la fonction</option>
